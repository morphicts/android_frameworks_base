...
public final class PowerManagerService extends SystemService
    ...
    private final class BinderService extends IPowerManager.Stub {
        ...
        private void runWithProximityCheck(Runnable r) {
			...
			// Test proximity always!
            boolean hasIncomingCall = false;//tm.getCallState() == TelephonyManager.CALL_STATE_RINGING;
        ...
        public void wakeUp(long eventTime, String reason, String opPackageName) {
			...
			// Always check proximity!
			wakeUpWithProximityCheck(eventTime, reason, opPackageName);
        }
